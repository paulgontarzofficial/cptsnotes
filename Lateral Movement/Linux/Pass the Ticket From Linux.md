- Setting the stage: Imagine that we are enumerating a network and find that a Linux host is connected to Active Directory. 
...
Using a script to find the keytab files:
```shell-session
...
![[Pasted image 20251029200750.png]]
