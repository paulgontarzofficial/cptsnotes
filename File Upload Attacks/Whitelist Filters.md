...
![Profile image update prompt with upload button, only images allowed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_whitelist_message.jpg)
...
![HTTP requests with various PHP payloads, all returning status 200, only images allowed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_whitelist_fuzz.jpg)
...
![POST request to /upload.php with PHP file disguised as image, filename 'shell.jpg.php'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_double_ext_request.jpg)
...
![UID, GID, and groups all set to 33 (www-data).](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_php_manual_shell.jpg)
...
![POST request to /upload.php with file 'shell.php.jpg' disguised as image.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_reverse_double_ext_request.jpg)
