...
![Update profile image with upload button; extension not allowed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_disallowed_type.jpg)
...
![HTTP POST request to /upload.php with file HTB$.php$, attack type Sniper.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_burp_fuzz_extension.jpg)
...
![Table of payloads with HTTP status 200, file successfully uploaded.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_burp_intruder_result.jpg)
...
![HTTP POST request to /upload.php with file shell.phtml, response 200 OK, file successfully uploaded.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/136/file_uploads_php5_web_shell.jpg)
