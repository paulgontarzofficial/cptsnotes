...
```shell-session
realCustampin@htb[/htb]$ sudo responder -wrf -v -I tun0
                                         __
  .----.-----.-----.-----.-----.-----.--|  |.-----.----.
  |   _|  -__|__ --|  _  |  _  |     |  _  ||  -__|   _|
...
```shell-session
realCustampin@htb[/htb]$ hashcat -m 5600 hash /usr/share/wordlists/rockyou.txt
