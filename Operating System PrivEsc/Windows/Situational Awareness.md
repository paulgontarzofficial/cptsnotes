When put into a situation, we need to get comfortable with where we are placed in our penetration test. 

When first getting into a windows box, we can first gather the network information where we can get a good reading of what we are working with. 
...
Modern environments have some sort of anti-virus or Endpoint Detection and Response (EDR) Service running monitor, alert on, and block threats proactively. These present some sort of challenge when it comes to a penetration test. 
