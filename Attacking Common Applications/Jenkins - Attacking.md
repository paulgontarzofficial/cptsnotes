...
![Jenkins Script Console with Groovy script to execute 'id' command, showing result as 'uid=0(root) gid=0(root)'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/113/groovy_web.png)
