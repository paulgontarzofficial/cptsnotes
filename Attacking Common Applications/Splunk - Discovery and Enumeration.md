...
![Splunk Enterprise login page with fields for username and password, default credentials 'admin' and 'changeme' provided.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/113/changme.png)
...
![Splunk Enterprise login page with fields for username and password, and instructions for first-time sign-in using default credentials 'admin' and 'changeme'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/113/splunk_login.png)
...
```shell-session
realCustampin@htb[/htb]$ sudo nmap -sV 10.129.201.50
...
![Splunk license group selection with options for Enterprise, Forwarder, Free, and Enterprise Trial licenses, highlighting no valid Enterprise licenses installed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/113/license_group.png)
