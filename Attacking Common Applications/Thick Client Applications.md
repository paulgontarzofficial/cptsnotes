...
![Diagram comparing two-tier and three-tier applications. Two-tier: direct interaction between application and database. Three-tier: application interacts with database through an application server.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/113/thick_clients/arch_tiers.png)
