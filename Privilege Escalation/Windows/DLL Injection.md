...
![Process Monitor window showing multiple 'CreateFile' operations by main.exe. Paths include various DLL files. Results mostly 'NAME NOT FOUND' with details on desired access and attributes.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/procmon-not-found.png)
...
![Command prompt showing a program that adds two numbers. Input: 1 and 1. Output: 'Hijacked... Oops...' message, sum is correctly displayed as 2.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/hijack.png)
